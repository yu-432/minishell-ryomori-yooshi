...
SRCS		= 	src/main.c \
				...
				src/lexer/expand.c src/lexer/expand_dollar.c \
				...
				src/execution/run_command.c src/execution/execute_helper.c \
				src/execution/process.c src/execution/redirect.c \
				src/execution/execute.c src/execution/fd_manager.c \
				src/execution/heredoc.c src/execution/node_helper.c src/execution/node.c \
				src/execution/wrapper.c src/execution/pipe.c \
