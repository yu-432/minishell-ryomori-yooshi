...
SRCS		= 	src/main.c \
				...
				src/execution/multi_command_process.c src/execution/redirect.c \
				...
				src/execution/wrapper.c src/execution/redirect_interpret.c src/execution/set_exit_status.c\
