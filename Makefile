...
SRCS		= 	src/main.c \
				...
				src/builtin_func/builtin_echo.c src/builtin_func/builtin_env.c src/builtin_func/builtin_export.c src/builtin_func/builtin_unset.c src/builtin_func/builtin_cd.c src/builtin_func/builtin_exit.c src/builtin_func/builtin_pwd.c
